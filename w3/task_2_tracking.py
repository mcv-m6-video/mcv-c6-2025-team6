...
import numpy as np
import os
from w3.task_2_sort import Sort
...
def process_video_and_save_results(input_video, txt_file, output_folder, overlap_threshold=0.9, output_video=False, movement_threshold=3.0, static_frame_threshold=2000):
...
if __name__ == "__main__":
    input_video = "data/aic19-track1-mtmc-train/train/S03/c015/vdo.avi"  
    txt_file = "data/aic19-track1-mtmc-train/train/S03/c015/detections.txt"  
    output_folder = "data/aic19-track1-mtmc-train/train/S03/c015/output_tracking" 
    # input_video = "data/AICity_data/train/S03/c010/vdo.avi"
    # txt_file =  "data/AICity_data/train/S03/c010/detections.txt"
    # output_folder = "data/AICity_data/train/S03/c010/output_tracking" 
