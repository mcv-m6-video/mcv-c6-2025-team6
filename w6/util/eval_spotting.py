...
def evaluate(model, dataset,output_dir, batch_size=INFERENCE_BATCH_SIZE, nms_window = 5):
    pred_dict = {}
    ...
    for clip in tqdm(DataLoader(
        ...
        for i in range(clip['frame'].shape[0]):
            ...
            # -----------------------------------------------
            # 🔍 NUEVO BLOQUE: imprimir predicciones por frame
            # -----------------------------------------------
            frame_preds = pred_scores.argmax(axis=1)  # clase más probable por frame (sin BG)
